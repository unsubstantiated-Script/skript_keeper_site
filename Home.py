...
with col2:
    ...
    content = """I'm a polyglot software engineer and administrator; 
    leveraging expertise gained over many years of work in the education sector as well as advanced software design 
    for insurance and real estate agencies. I began my career as an English instructor in Washington and 
